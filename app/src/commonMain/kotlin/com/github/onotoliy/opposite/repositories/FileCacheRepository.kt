...
class FileCacheRepository: IFileRepository {
    override suspend fun download(uuid: String): DrawableResource {
        return Res.drawable._29a98ff153997867b0760fd8d812f12478e180a3
    }
}