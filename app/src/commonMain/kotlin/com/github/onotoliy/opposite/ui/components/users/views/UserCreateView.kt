...
@Composable
expect fun UserCreateView(viewModel: UserNewViewModel, onSelect: (Screen) -> Unit)

@Composable
@OptIn(ExperimentalTime::class)
fun UserCreateMobileView(viewModel: UserNewViewModel, onSelect: (Screen) -> Unit) {
...
@Composable
@OptIn(ExperimentalTime::class)
fun UserCreateWebView(viewModel: UserNewViewModel, onSelect: (Screen) -> Unit) {
    var name by remember { mutableStateOf("") }
    var login by remember { mutableStateOf("") }
    var birthday by remember { mutableStateOf(Clock.System.now()) }
    var joiningDate by remember { mutableStateOf(Clock.System.now()) }
